...
var Messenger = function(el){
  ...
  m.init = function(){
    ...
    m.messages = [
      'YAMINI PRADHAN',
      'A hard working and creative Full-Stack Developer',
...
window.onload = function() {
  ...
  var chart = new CanvasJS.Chart("programming-chartContainer", {
    ...
    data: [{
      ...
      indexLabel: "{label} - {y}%",
      dataPoints: [
        { y: 51.08, label: "Java,JavaScript,HTML5,CSS" },
        { y: 37.39, label: "C,C++,C#" },
        { y: 9.09, label: "C#,.NET,XML" },
        { y: 1.66, label: "Assembly" },
      ]
    }]
  });
  chart.render();
...
$('#tab-2-link').on('click',function(){
  ...
  $('#tab-1').hide();
    $('#tab-3').hide();
    $('#tab-2').show();
    var chart = new CanvasJS.Chart("web-fm-chartContainer", {
    	theme: "light2", // "light1", "light2", "dark1", "dark2"
    	exportEnabled: false,
    	animationEnabled: true,
      title: {
...
$('#tab-3-link').on('click',function(){
  ...
  $('#tab-1').hide();
    $('#tab-2').hide();
    $('#tab-3').show();
    var chart = new CanvasJS.Chart("db-chartContainer", {
    	theme: "light2", // "light1", "light2", "dark1", "dark2"
    	exportEnabled: false,
    	animationEnabled: true,
      title: {
    	...
    	data: [{
    		...
    		indexLabel: "{label} - {y}%",
    		dataPoints: [
    			{ y: 60.17, label: "PostgreSQL" },
    			{ y: 37.39, label: "Oracle MySQL" },
    			{ y: 1.66, label: "MSSQL" },
    		]
    	}]
    });
